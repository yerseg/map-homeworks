...
В консоль во время работы программы должно построчно для каждого потока выводиться:
 ...
 Строки прогресс-баров каждого потока должны выводиться одновремено. Время появления каждого ноовго символа в строке прогресс-бара подобрать так, что бы процесс заполнения строки был виден. 
